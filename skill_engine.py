...
Danger commands:
  markdangerous:<dir>  Mark an exit from the CURRENT room as a death-trap link;
                      it will be avoided by all future goto: and explore: pathfinding.
                      <dir> is the direction word (north/south/east/west/up/down
                      or abbreviation).
